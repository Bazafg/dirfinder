...
_regex = {
       'chat_id' : r'chat_id',
    'restdb' : r'restdb',
    'quiknode.pro' : r'quiknode.pro', #quiknode.pro
    'chatId' : r'chatId',
    'x-apikey' : r'x-apikey',
    'nodereal.io' : r'nodereal.io',
    'api.telegram.org' : r'api.telegram.org',
    'org/bot' : r'org/bot',
    'responsiveClass' : r'responsiveClass',
    'PrivateKey' : r'PrivateKey',
    
    #'apple-touch-icon' : r'apple-touch-icon',
    #'datafeedSupportedResolutions' : r'datafeedSupportedResolutions',
    
    #'_originDataFn' : r'_originDataFn',        
}
...
def cli_output(matched):
    ...
    for match in matched:
        ...
        with open('results.txt', 'a', encoding="utf8") as the_good:
            the_good.write(url + " " + str(match.get('matched').encode('ascii','ignore').decode('utf-8')) + "\n")
        print('good', url)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-g","--ignore",help="Ignore js url, if it contain the provided string (string;string2..)",action="store",default="ajax.googleapis.com;cdn.jsdelivr.net;unpkg.com")
